...
namespace Dynamo.Tests
{
    ...
    class SelectionTests : RevitNodeTestBase
    {
        ...
        {
            Assert.Inconclusive("Requires reference to workspace model.");
        ...
        public void SelectElementsASTGeneration()
        {
            ...
            //var sel = new DSModelElementsSelection { SelectedElement = refPoints.Cast<Element>().Select(x => x.Id).ToList() };
