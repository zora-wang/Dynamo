...
namespace DSCore
{
    ...
    public static class String
    {
        ...
        /// <search>tonumber,2number,str2number,strtonumber,string2number,stringtonumber</search>
        ...
        /// <search>length,count,size,characters</search>
        ...
        /// <summary>
        ///     Divides a single string into a list of strings, with divisions determined by
        ...
        /// <search>split,divide,separaters</search>
        ...
        /// <returns name="str">Fully uppercase string.</returns>
        /// <search>uppercase,case,toupper,2upper</search>
        ...
        /// <returns name="str">Fully lowercase string.</returns>
        /// <search>lowercase,case,tolower,2lower</search>
        [IsVisibleInDynamoLibrary(false)]
        ...
        /// </param>
        /// <returns name="str">
        ///     Fully uppercase or fully lowercase string based on input upper.
        /// </returns>
        /// <search>uppercase,toupper,2upper,lowercase,tolower,2lower,case,stringcase</search>
        [IsVisibleInDynamoLibrary(false)]
        ...
        /// <search>startswith,beginswith</search>
        ...
        /// <returns name="cleaned">String with beginning and ending whitespaces removed.</returns>
        /// <search>trim,clean,trimstring,cleanstring,whitespace,blanks,spaces</search>
        ...
        /// <param name="searchFor">Substring to search for.</param>
        /// <param name="ignoreCase">Whether or not comparison takes case into account.</param>
        /// <returns name="index">Index of the first occurence of the substring or -1 if not found.</returns>
